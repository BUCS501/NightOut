...
public class NoNetworkFragment extends Fragment {
    ...
    private TextView no_network_label;
    ...
    public void onStart() {
        super.onStart();
        no_network_label = getView().findViewById(R.id.no_network_label);
        no_network_image = getView().findViewById(R.id.no_network_image);
    }
}